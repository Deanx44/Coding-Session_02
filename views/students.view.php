...
<body>
    ...
    <div class="content">
		<div class="flex">
          <h2 style="width:25%">Student Records</h2>
        ...
        <table class="orange-theme">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="student_edit.php?id=<?php echo $result['id']; ?>"><i style="font-size:24px;color:forestgreen" class="fa fa-edit"></i></a>
                        <a href="student_delete.php?id=<?php echo $result['id']; ?>"><i style="font-size:24px;color:orangered" class="fa fa-trash"></i></a>
                    </td>
                </tr>
            <?php } ?>
            </tbody>
        ...
        <div class="pagination">
            <?php
                $row = $student->getStudentsCount();
                $totalPages = ceil($row / 1000);
